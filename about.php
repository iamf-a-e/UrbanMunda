  ...
  <body>
  	...
  	<div class="container">
  		<div class="row">
  			...
  			<div class="col-md-4">
  			 <div class="brand">
 				<img src="img/urbanmunda.jpg" alt="Logo" style="height: 50px; margin-left: 0px;"> <!-- Adjust logo size and margin -->
  			 	 <h2><span></span></h2>
  			 </div>	
  			</div>
  			<div class="col-md-4">
...
<!--end of nav---mc_-->
      ...
      <div class="container sub_about">
        <h3>ABOUT US</h3>
         ...
         <p>Urban Munda is an online shopping site where customers can order fresh fruits and vegetables. It offers a variety of fruits and vegetables with the best quality and freshness.</p>

         <p>Urban Munda provides Fruits And Vegetables directly from farmers to Customers. Our Customers Can Choose from a large variety of fresh fruits and vegetables And Order Easily from Anywhere within Zambia and have the order delievered to their doorstep.</p>

         <p>Payment and Logistics policy</p>
         <p>   1.Cash on delivery</p>
         <p> 2.VEG VILLAGE accepts all debit cards, credit cards.</p>
