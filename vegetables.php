    ...
    <ul class="navbar-nav ">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="Logup">Signup</a>
...
<!--end of nav---mc_-->
    ...
    <div class="row">
      ...
      <div class="col-md-3">
       ...
       <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531136694_tomato-local.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Tomato</p>
                       </div>
                       <div class="price">
  		       <span>1Kg</span><i class="kwacha-symbol">/K24</i>
                    <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531136694_tomato-local.jpg">
    ...
    <div class="row">
      <div class="col-md-3">
         <div class="thumbnail">
                <img src="1531140750_cabbage2.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>White Cabbage</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K50</i>
                      <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531140750_cabbage2.jpg">
      ...
      <div class="col-md-3">
           <div class="thumbnail">
                <img src="1531140098_ladies-finger.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Ladies-finge</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K50</i>
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531140098_ladies-finger.jpg">
      ...
      <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531137046_bottle-gourd.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>bottle-gourd</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K35</i>
                     <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531137046_bottle-gourd.jpg">
       ...
       <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531140777_cauli-flower.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Cauliflower</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K24</i>
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531140777_cauli-flower.jpg">
    ...
    <div class="row">
      <div class="col-md-3">
         <div class="thumbnail">
                <img src="1531137330_radish.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>radish</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K45</i>
                      <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531137330_radish.jpg">
      ...
      <div class="col-md-3">
           <div class="thumbnail">
                <img src="1531137157_yellow-pumkin.jpg" width="100%" height="300px">
                <div class="caption">
  		       ...
  		       <span>1Kg</span><i class="kwacha-symbol">/K24</i>
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531137157_yellow-pumkin.jpg">
      ...
      <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531136905_cucumber.jpg" width="100%" height="300px">
                <div class="caption">
                  <p> Cucumber</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K55</i>
                    <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531136905_cucumber.jpg">
       ...
       <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531140721_raw-banana.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Raw Banana</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K20</i>
                    
                      <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531140721_raw-banana.jpg">
    ...
    <div class="row">
      <div class="col-md-3">
         <div class="thumbnail">
                <img src="1531137220_beetroot.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Beetroot</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K55</i>
                     <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531137220_beetroot.jpg">
      ...
      <div class="col-md-3">
           <div class="thumbnail">
                <img src="1531140113_gree-capsigum.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Green-capsigum</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K65</i>
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531140113_gree-capsigum.jpg">
      ...
      <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531136728_potato.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>potato</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K35</i>
                       ...
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531136728_potato.jpg">
       ...
       <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1605683173_Cluster-Beans.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Cluster-Beans</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K50</i>
                       ...
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1605683173_Cluster-Beans.jpg">
