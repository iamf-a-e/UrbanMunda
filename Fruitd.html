...
<!--end of nav---mc_-->
    ...
    <div class="row">
      <div class="col-md-3">
         <div class="thumbnail">
                <img src="1531141114_apple-washington.jpg" width="100%" height="300px">
                <div class="caption">
		       ...
		       <span>1Kg</span><i class="kwacha-symbol">/K50</i>
                     ...
                     <input type="hidden" name="image" value="1531141114_apple-washington.jpg">
      ...
      <div class="col-md-3">
           <div class="thumbnail">
                <img src="1531141352_banana-yelakki.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>banana-yelakki</p>
                       </div>
                       <div class="price">
 		       <span>1Kg</span><i class="kwacha-symbol">/K50</i>
                     ...
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531141352_banana-yelakki.jpg">
      ...
      <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531142452_guava-white.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Guava-white</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K35</i>
                     <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531142452_guava-white.jpg">
       ...
       <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531142511_amla.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>amla</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K24</i>
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531142511_amla.jpg">
  ...
  <br>
    ...
    <div class="row">
      <div class="col-md-3">
         <div class="thumbnail">
                <img src="1531142657_papaya.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Papaya</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K50</i>
                      <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531142657_papaya.jpg">
      ...
      <div class="col-md-3">
           <div class="thumbnail">
                <img src="1531142497_pinapple2.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Pinapple</p>
                       </div>
                       <div class="price">
               ...
               <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531142497_pinapple2.jpg">
      ...
      <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531142636_pomogranate-kabul.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Pomegranate</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K35</i>
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531142636_pomogranate-kabul.jpg">
...
<br>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
           <div class="thumbnail">
                <img src="1531142475_sapotta.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>sapotta</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K50</i>
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531142475_sapotta.jpg">
      ...
      <div class="col-md-3">
        ...
        <div class="thumbnail">
		       ...
		       <span>1Kg</span><i class="kwacha-symbol">/K35</i>
                       <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="orange.jpg">
       ...
       <div class="col-md-3">
        ...
        <div class="thumbnail">
                <img src="1531141529_sweetlime.jpg" width="100%" height="300px">
                <div class="caption">
                  <p>Sweetlime</p>
                       </div>
                       <div class="price">
		       <span>1Kg</span><i class="kwacha-symbol">/K24</i>
                        <form method="post" action="manage.php">
                     <p><input type="submit" name="sub" value="Add to Cart" class=" btn bg-success  text-white"></p>
                     <input type="hidden" name="image" value="1531141529_sweetlime.jpg">
